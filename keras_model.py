...
if __name__ == '__main__':
    ...
    #this gets score(mae) 0.0649729 on public LB
    ...
    encoded = Dropout(0.2)(Dense(48, activation='relu')(l_input))
    encoded = Dense(32, activation='relu')(encoded)
    encoded = Dense(20, activation='relu', name = 'encoded_layer')(encoded)
    decoded = Dropout(0.2)(Dense(32, activation='relu')(encoded))
    ...
    #0.067367520021355667
    best_model = load_model('./weights/best_model.hdf5')
    best_model.evaluate([x_train_sub[:,:-1], x_train_sub],y_train_sub,batch_size=10000)
    #0.067344621059076501
    
    test_submit_autoencoder_nn(best_model, sample_nn.drop(['parcelid', 'logerror'], axis=1).columns.values)
